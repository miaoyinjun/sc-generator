...
/**
 * Created by wuyu on 2015/2/3.
 */

public class GroovyGeneratorJpa extends AbstractGeneratorJpa {


    public GroovyGeneratorJpa(String url,String username, String password,  String driverClass, String project, String packagePath,List<String> tables) {
...
//                .append("\r\n\r\n")
    ...
    public String genServiceImpl(String basePath, String project, String packagePath, List<MetaData> metaDates, String primaryKey,String primaryType, String modelName) {
        ...
        sb.append("package " + packagePath + ".service.impl")
                ...
                .append("\r\n\r\n")
                .append("@Service\r\n")
                .append("class " + modelName + "ServiceImpl implements " + modelName + "Service{")
                .append("\r\n\r\n")
                .append("\t@Autowired")
                .append("\r\n")
...
//                columnType = "java.util.Date";
//            }
//            sb.append("\t" + columnType + " get" + VelocityUtil.firstUp(columnName) + "(){\r\n")
//                    .append("\t\treturn " + columnName)
//                    .append("\r\n\t}")
//                    .append("\r\n\r\n")
//                    .append("\t" + modelName + " set" + VelocityUtil.firstUp(columnName) + "(" + columnType + " " + columnName + ") {\r\n")
...
//        }
    ...
    public String getPomPath() {
        return "/templates/pom/springboot/groovy/jpa/pom.vm";
    }

    @Override
    public String getApplicationPath() {
        return "/templates/pom/springboot/groovy/jpa/application.yml";
    }

    @Override
    public String getMain() {
        return "/templates/pom/springboot/groovy/jpa/Main.vm";
    }
