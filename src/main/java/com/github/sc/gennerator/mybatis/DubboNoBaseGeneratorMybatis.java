...
/**
 * Created by wuyu on 2015/6/12.
 */
public class DubboNoBaseGeneratorMybatis extends SpringBootNoBaseGeneratorMybatis {


    public DubboNoBaseGeneratorMybatis(String url, String username, String password, String driverClass, String project, String packagePath, List<String> tables,  boolean multiProject,boolean swagger) {
