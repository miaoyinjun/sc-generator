 ...
 */
public class SpringBootThymeleafNoBaseGeneratorMybatis extends SpringBootNoBaseGeneratorMybatis {


    public SpringBootThymeleafNoBaseGeneratorMybatis(String url, String username, String password, String driverClass, String project, String packagePath, List<String> tables, boolean multiProject, boolean swagger) {
