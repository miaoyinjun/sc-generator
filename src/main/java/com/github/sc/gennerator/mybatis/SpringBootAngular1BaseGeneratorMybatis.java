 ...
 */
public class SpringBootAngular1BaseGeneratorMybatis extends SpringBootBaseGeneratorMybatis {


    public SpringBootAngular1BaseGeneratorMybatis(String url, String username, String password, String driverClass, String project, String packagePath, List<String> tables, String baseCPackagePrefix, boolean multiProject, boolean swagger) {
